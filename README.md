...
| **Monitoring** | uptime-kuma | 3001 | service checks, defined by [`scripts/uptime-kuma-monitors.py`](scripts/uptime-kuma-monitors.py) |
...
└── data/                    Samba share
    └── media/               FOLDER_FOR_MEDIA
        ├── library/         tv, anime, arabic-shows, movies, comics, youtube (Pinchflat downloads)
