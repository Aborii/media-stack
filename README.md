...
| | audiobookshelf | 13378 | audiobooks and podcasts; also serving a copy of the book library on trial against Kavita |
...
└── data/                    Samba share
    └── media/               FOLDER_FOR_MEDIA
        ...
        ├── books-abs/       copy of books/, Audiobookshelf trial only
